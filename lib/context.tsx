  ...
  try {
    ...
    const subjects = a(d.subjects, 'subjects').map((subj: any) => ({
      ...
      topics: a(subj.topics, `subject[${subj.id}].topics`).map((t: any) => ({
        ...
        customQuestions: Array.isArray(t.customQuestions) ? t.customQuestions.map((q: Record<string, unknown>) => ({
          question: typeof q.question === 'string' ? q.question : '',
          answer: typeof q.answer === 'string' ? q.answer : '',
          bloomLevel: typeof q.bloomLevel === 'number' ? q.bloomLevel : undefined,
          enrichedAnswer: typeof q.enrichedAnswer === 'string' ? q.enrichedAnswer : undefined,
