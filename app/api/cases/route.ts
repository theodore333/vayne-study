...
- На БЪЛГАРСКИ, професионален тон`
    }]
  });
...
ВАЖНО: suggestedImages - предложи 1-3 изображения (ЕКГ, рентген, анатомични снимки, инструменти), които студентът да качи в материалите си за по-добро запомняне.`
    }]
  });
